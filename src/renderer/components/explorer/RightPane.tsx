...
function defineOmniMonacoThemes(monaco: typeof import('monaco-editor')): void {
  ...
  monaco.editor.defineTheme(OMNICODE_MONACO_THEMES.light, {
    ...
    rules: [
      ...
      { token: 'keyword', foreground: '2F6FB5' },
      { token: 'predefined', foreground: '2E7E72' },
      { token: 'type', foreground: '2E7E72' },
      { token: 'identifier', foreground: '2B241C' },
      { token: 'constructor.identifier', foreground: '7A5A2D' },
      { token: 'namespace.instance.identifier', foreground: '355E8A' },
      { token: 'namespace.class.identifier', foreground: '355E8A' },
      { token: 'global.constant', foreground: '355E8A' },
      { token: 'string', foreground: '9A3F2C' },
      { token: 'string.s', foreground: '8A3FA1' },
      { token: 'string.heredoc', foreground: '9A3F2C' },
      { token: 'string.heredoc.delimiter', foreground: '7A5A2D' },
      { token: 'string.escape', foreground: '355E8A' },
      { token: 'string.escape.curly', foreground: '8A3FA1' },
      { token: 'regexp', foreground: '7A2F4D' },
      { token: 'regexp.escape', foreground: '8A3FA1' },
      { token: 'regexp.escape.control', foreground: '8A3FA1' },
      { token: 'number', foreground: '3A7A55' },
      { token: 'number.hex', foreground: '3A7A55' },
      { token: 'number.octal', foreground: '3A7A55' },
      { token: 'number.binary', foreground: '3A7A55' },
      { token: 'number.float', foreground: '3A7A55' },
      { token: 'operator', foreground: '2B241C' },
      { token: 'delimiter', foreground: '2B241C' },
      { token: 'delimiter.parenthesis', foreground: '2B241C' },
      { token: 'delimiter.curly', foreground: '2B241C' },
      { token: 'delimiter.square', foreground: '2B241C' },
      { token: 'variable', foreground: '355E8A' },
      { token: 'variable.parameter', foreground: '355E8A' },
      { token: 'constant', foreground: '355E8A' },
      { token: 'function', foreground: '7A5A2D' },
      { token: 'invalid', foreground: 'B71C1C' },
    ],
    colors: {
      'editor.background': '#FCF8F0',
      'editor.foreground': '#2B241C',
      'editorLineNumber.foreground': '#A38F73',
      'editorLineNumber.activeForeground': '#6B5A45',
      'editorCursor.foreground': '#3B3025',
      'editor.selectionBackground': '#DCE7F4',
      'editor.inactiveSelectionBackground': '#EDE4D6',
      'editorLineHighlightBackground': '#F1E8DA',
      'editorLineHighlightBorder': '#00000000',
      'editorGutter.background': '#FCF8F0',
      'editorIndentGuide.background1': '#D7C9B4',
      'editorIndentGuide.activeBackground1': '#B79F80',
      'editorWhitespace.foreground': '#DCCFBC',
